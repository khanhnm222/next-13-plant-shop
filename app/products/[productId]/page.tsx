...
export default function ProductDetail() {
  ...
  return (
    <main className='flex flex-col items-center justify-between p-24'>
      <div className='flex flex-col lg:flex-row max-w-[1920px] lg:mt-10 lg:p-6 lg:gap-24 items-center' >
        <div className='flex flex-col gap-4 lg:basis-1/2 items-center'>
          <div className='relative'>
            ...
            >
              <Image src='/icon-previous-green.svg' alt='previous' width={16} height={16} />
            </button>
            <Image
        ...
        <div className='p-6 flex flex-col gap-5 lg:p-0 lg:basis-1/2'>
          <h3 className='text-primary text-xs lg:text-sm'>Plant Shop</h3>
          <h2 className='text-2xl font-bold lg:text-4xl'>Monstera Deliciosa</h2>
          <p className='text-dark-grayish-blue text-sm lg:text-base'>
            Monstera Deliciosa is set with the Queen symbol of the houseplants, houseplants. Monstera deliciosa prefers a cool, humid climate, with green leaves year round, and is easy to care for.
          </p>
          ...
          <div className='flex flex-col gap-4 lg:flex-row'>
            <div className='relative lg:basis-1/3'>
              <button
                className='absolute translate-y-[-50%] top-[50%] left-6'
                onClick={() => (countToAdd > 0 ? setCountToAdd((prev) => prev - 1) : null)}
              >
                <Image src='/icon-minus.svg' alt='minus' width={16} height={16} />
              </button>
              <input
                type='number'
                value={countToAdd}
              ...
              >
                <Image src='/icon-plus.svg' alt='plus' width={16} height={16} />
              </button>
            </div>
            <button
              className='flex gap-4 h-3 text-center bg-primary justify-center items-center text-white font-bold p-6 rounded-2xl hover:bg-secondary hover:text-brand-green lg:basis-2/3'
            >
              <Image src='/icon-cart-white.svg' className='text-white' alt='cart' width={30} height={30} /> Add to cart
            </button>
          </div>
        </div>

        <div
          className={`hidden ${lightboxOpen ? 'lg:flex' : ''} justify-center items-center w-full h-full bg-black bg-opacity-75 absolute left-0 top-0`}
        >
          <div className='flex flex-col gap-8 items-center max-w-[800px] max-h-[80vh]'>
            <button className='self-end' onClick={() => setLightboxOpen(false)}>
              <Image
                ...
                onMouseEnter={(e) => (e.currentTarget.src = '/icon-close-green.svg')}
                onMouseLeave={(e) => (e.currentTarget.src = '/icon-close-white.svg')}
                alt='close'
                width={16}
                height={16}
              />
            ...
            <div className='relative'>
              ...
              >
                <Image src='/icon-previous.svg' alt='previous' width={16} height={16} />
              </button>
              <Image
                className='lg:rounded-2xl lg:cursor-pointer'
                src='/monstera.webp'
