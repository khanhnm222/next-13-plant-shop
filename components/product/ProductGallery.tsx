        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-wrap self-start justify-evenly md:gap-5 sm:gap-5 xs:gap-5">
            ...
            <div className="w-full md:w-full lg:w-1/2 lg:mb-0">
              <div className="relative overflow-hidden rounded-md shadow-md group">
                <Image src="/Plant_gallery_0.jpg"
                  width={1000}
                  height={625}
                  className="group-hover:origin-center group-hover:scale-110 group-hover:rotate-3 h-[625px] w-full transition duration-500 object-cover"
                  alt=""
                />
                <div
